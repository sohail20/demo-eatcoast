...
import HeadBar from "screens/Menu2/Components/HeadBar/HeadBar";
    ...
    <>
      <Box component="container">
        ...
        <>
          ...
          <Box>
            {true ? (
              <AddCuisine isOpen={isShown} setIsShownButtonBoxFunc={setIsShownButtonBox} handleClose={() => setIsShown(false)} handleSelected={(e) => { setSelectedCuisine(e) }} />
            ) : (
              <ImageSection />
            )}
          </Box>
