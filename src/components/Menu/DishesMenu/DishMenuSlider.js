...
export default function DishMenuSlider({ isDrawerOpenStaff, setIsDrawerOpenStaff }) {
    ...
    const handleAddselecIng =(addQty)=>{
       ...
       console.log([ingredientonFly].map(item=> [...item, Qty  ]))
                    ...
                    <Box component={'div'} sx={{ marginTop: '20px' }}>
                        ...
                        {searchQuerry.length > 0 ? (
                            searched.map(search => {
                                return (
                                    <MenuItem
                                        sx={{ '&:hover': { background: 'none' }, border: '1px solid #E1E1E6', marginleft: '10px', marginRight: '10px', borderRadius: '6px', background: '#FFFFFF', mb: 1 }}
