...
export const Da_staff = ({ info }) => {
  ...
  const { data: staffDash, isLoading } = useGetStaffDashQuery({
    catererId: info._id,
  });
      ...
      <>
        <Box component={"div"}>
          ...
          >
            ...
            >
              <Box
                sx={{ display: "flex", marginTop: { xs: "10px", sm: "0px" } }}
              >
                <Button
                  size="small"
          ...
          <Grid container spacing={1}>
            ...
            >
              <DashInfoCard
                icon={"../../images/allOrder.svg"}
                title="All Orders"
                clicked={clicked}
                count={staffDash.data.allOrder}
              />
            </Grid>
            ...
            >
              <DashInfoCard
                ...
                title="All Meal Courses"
                clicked={clicked1}
                count={staffDash.data.countMealCourse}
              />
            </Grid>
            <Grid
              item
            ...
            >
              <DashInfoCard
                icon={"../../images/milk.svg"}
                title="All Add-Ons"
                clicked={clicked3}
                count={staffDash.data.countAddOnes}
              />
            </Grid>
          </Grid>
        </Box>
            ...
            <Grid item xs={12} md={4} lg={4}>
              ...
              >
                <Box sx={{ padding: "5px 20px", borderRadius: "6px" }}>
                  ...
                  <Box component={"div"}>
                    {staffDash &&
                      staffDash.data &&
                      staffDash.data.TopSellingMP.length > 0 ? (
                      staffDash.data.TopSellingMP.map((item, i) => {
                        return (
              ...
              <Grid item xs={12} md={12} sx={{ borderRadius: "6px" }}>
                ...
                >
                  ...
                  <Box component={"div"}>
                    <DonutChart
                      figure={Object.values(staffDash.data.allSubscriptions)}
                    />
                  </Box>
                </Box>
              </Grid>
      ...
      <Box componet={"div"}>
        <Typography
          ...
          sx={{
            ...
            borderRadius: clicked ? "8px" : "white",
