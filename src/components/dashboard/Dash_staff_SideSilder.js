...
export const Dash_staff_SideSilder = ({
  isDrawerOpenStaff,
  setIsDrawerOpenStaff,
  setIsDrawerOpenStaff1,
  isDrawerOpenStaff1,
  handleSideSliderStaff,
  setIsDrawerOpenStaff2,
  isDrawerOpenStaff2,
  handleSideSliderStaff1,
}) => {
  const staffApi = [
    {
      id: "UEC-12345",
      ...
      >
        ...
        >
          <Typography
            ...
            component="div"
            textAlign={"start"}
            sx={{ color: "#1A1824", cursor: "pointer", fontSize: "16px" }}
            onClick={() => {
          ...
          <Box component={"div"}>
            ...
            <Box justifyContent={"flex-end"} paddingRight={0} mt={5}>
              ...
              <Button
                ...
                size="small"
                onClick={handleSideSliderStaff1}
                variant="contained"
                disableElevation
              >
                Accept request
                ...
                <Box mb={2}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Radio
                        {...controlProps("OutItem")}
                        defaultValue="Out of an item"
                        size="small"
                        sx={{
                          "&, &.Mui-checked": {
                            color: "#2B817B",
                ...
                <Box mb={2}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Radio
                        {...controlProps("restuarantProblem")}
                        size="small"
                        sx={{
                          "&, &.Mui-checked": {
                            color: "#2B817B",
