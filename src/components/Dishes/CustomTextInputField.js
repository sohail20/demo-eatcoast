...
const CustomTextInputField = ({label, name, value, onChangeHandler, onBlurHandler, placeholder, errors, touched, multiline, rows, required=false, isPasswordField=false, lableFontSize, lableFontWeight, labelSx,...other}) => {
...
//                     name='username' 
//                     value="John Doe"
//                     isPasswordField={flase}
//                     placeholder='Type message ...' 
//                     fullWidth
//                     lableFontSize="18px" 
//                     lableFontWeight="500"
//                     type="password"
//                     sx={{padding:"10px 0",'&:hover':{borderColor:"red"}}}
// 		    labelSx={{padding:"10px 0",'&:hover':{borderColor:"red"}}}
//                   />    



{/* <CustomTextInputField label='User Name'
name='username' 
value="John Doe"
