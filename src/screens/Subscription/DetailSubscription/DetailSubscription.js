...
const DetailSubscription = ({setShowDetailSubscriptionFunc}) => {
                ...
                <Grid item xs={12} md={5.8} p="10px" my={1}>
                    ...
                    <Box sx={{mx:{md:2}}}>
                        <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center" my="10px">
                            <Chip label="Personal subscription" variant="contained" sx={{background:"#7B49E5", borderRadius: '6px', color: '#fff',my:"3px"}} />
                        ...
                        <Box my="5px">
                            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center" my="15px">
                                <Box my="3px">
                                    ...
                                    <Typography component="span" sx={{verticalAlign:"top",ml:"5px",fontSize:{xs:"13px",md:"14px"}}} color="#545359" fontWeight="500">
                                        Weekly subscription :</Typography>
                                </Box>
                                <Box my="3px">
                            ...
                            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center" border="1px solid #E1E1E6" borderRadius="4px" p="2px 8px" my="15px">
                                <Typography component="span" sx={{verticalAlign:"top",ml:"5px",fontSize:{xs:"11px",md:"16px"}}} color="#1A1824" fontWeight="400">Thursday, Sept 02, 2021</Typography>
                                    -
                                <Typography component="span" sx={{verticalAlign:"top",ml:"5px",fontSize:{xs:"11px",md:"16px"}}} color="#1A1824" fontWeight="400">Monday, Sept 09, 2021</Typography>
                            </Box>
                        </Box>
                        <Box my="5px">
                    ...
                    <Box sx={{mx:{md:2}}} my="5px">
                        <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center" my="10px">
                            <Typography  sx={{fontSize:{xs:"13px",md:"18px"}}} color="#9EA3AE" fontWeight="600">
                                ID : UEC - 12345</Typography>
                            <Box sx={{border: '1px solid #81D9A5',bgcolor:'#F1FFF7' ,borderRadius: '4px',
                            p:"2px 9px"}}>
                                <Typography  sx={{fontSize:{xs:"13px",md:"14px"}}} color="#30A15F" fontWeight="400">Active</Typography>
                            </Box>
                        </Box>
