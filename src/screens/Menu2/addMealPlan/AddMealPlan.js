...
import "./style.css";
import { useMealplaneAddMutation } from "api/mealplane";
...
function AddMealPlan({selectedCuisine, handleOnClose }) {
  ...
  const [tmpImage, setTmpImage] = useState(profile);
  const [addMealPlan, { isAddingMealPlan }] = useMealplaneAddMutation();
  ...
  const handleSubmitMealPlan = () => {
    ...
    const formObject = {
      ...mealPlanData,
      mealCourse: mealCheckBoxes.join(","),
      endDate,
      forReview: true,
      addOnes: drawerMeal,
    ...
    Object.keys(formObject).map((keys) => {
      formData.append(keys, formObject[keys]);
    });
          ...
          <Box>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <img src={image} style={{ width: "96px", height: "97px" }} />
                  ...
                  >
                    <input
                      ...
                      onChange={(event) => {
                        ...
                        setTmpImage(event.currentTarget.files[0]);
                      }}
                    />
                    <img src={add} />
                    Add photo
              ...
              >
                <Box>
                  ...
                  >
                    *when the toggle switch is on, the menu will be sent to
                    admin for review and once done the menu will show
                  </Para>
                </Box>
                <Box>
                  <Switch
                    checked={mealPlanData.reviewStatus}
                    onChange={(e) =>
                      setMealPlanData({
                        ...mealPlanData,
                        reviewStatus: e.target.value === "on" ? true : false,
                      })
                    }
            ...
            >
              <Box
                sx={{ width: { lg: "40%", md: "40%", sm: "40%", xs: "90%" } }}
              >
                <Para
                  sx={{ fontSize: "16px", fontWeight: "600", marginTop: 1 }}
                >
                  Meal Plan
                </Para>
                <OutlinedInput
                ...
                >
                  <Para
                    sx={{ fontSize: "16px", fontWeight: "600", marginTop: 2 }}
                  >
                    Description
                  </Para>
                  <Para
                    sx={{ marginTop: 2, fontSize: "14px", fontWeight: "500" }}
                  >
                    {word}/80
                  </Para>
                </Box>
