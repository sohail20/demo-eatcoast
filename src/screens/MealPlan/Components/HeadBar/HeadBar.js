...
function HeadBar() {
  ...
  const [isShowAddMealPlanScreen, setIsShowAddMealPlanScreen] = useState(false);
  ...
  return (
    <>
      {
        isShowAddMealPlanScreen ? (
          <AddMealPlan setIsShowAddMealPlanScreenFunc={setIsShowAddMealPlanScreen}/>
        )
        :
        (
          <Box
            ...
            >
              ...
              <Btn
                sx={{
                  ...
                  textTransform:"capitalize",'&:hover':{bgcolor:"#2B817B"}
                }}
                onClick={()=> setIsShowAddMealPlanScreen(true)}
              >
                Add Meal Plan
              </Btn>
            </Box>
