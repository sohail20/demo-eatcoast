    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
                    ...
                    <Grid item xs={12} sx={{ marginTop: '80px' }} >
                        ...
                        <Link to={'#'} >
                            ...
                            >
                                ...
                                <span style={{
                                    fontFamily: 'Outfit', textDecorationLine: 'underline',
                                    textDecorationColor: '#2B817B',
                                    color: '#FFFFFF', fontFamily: 'Outfit', fontSize: '16px'
                                }}>Open email app</span>
                            </Button>
                        </Link>
            ...
            <Box sx={{ margin: '30px' }}>
                ...
                <Link to={-1}>
                <Typography variant='body2' textAlign="center" component={'div'} 
                sx={{ letterSpacing: '1px', fontsize: '16px', fontFamily: 'Outfit', color: '#2B817B',
                     }}>
                        <span style={{
                            fontFamily: 'Outfit', textDecorationLine: 'underline',
                            textDecorationColor: '#fff',
                            color: '#2B817B', fontFamily: 'Outfit', fontSize: '16px'
