...
import { useGetAuthenticateMutation, useVerifyLoginOTPMutation } from "api/authenticate";
...
export const Login = () => {
  ...
  const [verifyEmail, { isLoading: emailVerify }] = useVerifyLoginOTPMutation()
  ...
  const handleVerifyEmail = () => {
    verifyEmail({ email, otp }).then((res) => {
